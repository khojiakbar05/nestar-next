								...
								<TableRow hover key={'member._id'} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
									...
									<TableCell align="center">
										...
										<Menu
											...
											sx={{ p: 1 }}
										>
											<MenuItem onClick={(e: React.MouseEvent<HTMLElement>) => generateMentorTypeHandle('member._id', 'mentor', 'originate')}>
												<Typography variant={'subtitle1'} component={'span'}>
													MENTOR
												</Typography>
											</MenuItem>
											<MenuItem onClick={(e: React.MouseEvent<HTMLElement>) => generateMentorTypeHandle('member._id', 'user', 'remove')}>
												<Typography variant={'subtitle1'} component={'span'}>
													USER
												</Typography>
											</MenuItem>
